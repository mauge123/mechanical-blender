...
typedef struct BMReference_OFlag {
	BMReference base;
	struct BMFlagLayer *oflags;
} BMReference_OFlag;
...
#define BM_ALL_NOLOOP (BM_VERT | BM_EDGE | BM_FACE | BM_DIM | BM_REFERENCE | BM_GEOMETRY)
/*
